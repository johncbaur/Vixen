...
namespace VixenApplication.Setup.ElementTemplates
{
	...
	public class IntelligentFixtureTemplate : IElementTemplate
	{
		...
		/// <param name="fixture">Fixture profile being processed</param>
		private void ProcessColorWheelFunction(bool isLampFixture, FixtureFunction function, ElementNode node, string fixtureName, FixtureSpecification fixture)
		{
        ...
        {			
			...
			{
				ProcessTaggedFunction(node, function, colorMixing, DimmingCurveSelection.NoDimmingCurve, null);
			}
		}
			...
			Curve dimmingCurve)
        {
			...
			switch(function.FunctionType)
            {
				...
				case FixtureFunctionType.Range:
					ProcessTaggedFunction(node, function, colorMixing, dimmingCurveSelection, dimmingCurve);
					break;
		...
		/// <param name="automaticallyOpenAndClosePrism">Whether to configure the filters to automatically open and close the prism</param>
		/// <param name="createGroup">Flag indicating whether to create a group</param>		
		/// <param name="dimmingCurveSelection">Dimming curve filter selection</param>
		/// <param name="dimmingCurve">Dimming curve to insert</param>
