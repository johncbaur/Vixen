...
namespace VixenModules.Editor.FixturePropertyEditor.ViewModels
{
	...
	/// </summary>
	public class ColorWheelViewModel : ItemsViewModel<ColorWheelItemViewModel>
	{
        #region Constructor 
		...
		/// </summary>
		/// <returns>True if the color wheel data is complete</returns>
		public bool IsDataComplete()
        {
			...
			foreach (ColorWheelItemViewModel colorWheelEntry in Items)
			{
				// If the color wheel item name is not populated then...
				if (string.IsNullOrEmpty(colorWheelEntry.Name))
				{
					// Indicate that the data is NOT complete
					isDataComplete = false;
				}

				// If the start value is not populated then...
				if (string.IsNullOrEmpty(colorWheelEntry.StartValue))
				{
					// Indicate that the data is NOT complete
					isDataComplete = false;
				}				
			...
			// Return whether the color wheel data is complete
