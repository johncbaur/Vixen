...
{
    /// <summary>
    /// View model for the fixture property editor.
    /// </summary>
    public class FixturePropertyEditorWindowViewModel : FixturePropertyWindowViewModelBase
    {
        ...
        {                        
            // Get the updated fixtured specification from the child view model
        ...
        FixturePropertyEditorViewModel GetChildViewModel()
        {
