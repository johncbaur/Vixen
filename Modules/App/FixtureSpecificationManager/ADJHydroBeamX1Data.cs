...
namespace VixenModules.App.FixtureSpecificationManager
{
	public class ADJHydroBeamX1Data : FixtureData
	{
		...
		public static string Name = "Hydro Beam X1 (14 Channel Mode)";
		...
		static private void InitializeX1Channels(FixtureSpecification specification)
		{
			...
			prism.Function = "Open Close Prism";
			prism.Name = "Prism";
			...
			shutterAndStrobing.Name = "Shutter";
			shutterAndStrobing.Function = "Shutter";
			...
			// Channel #5B
			//FixtureChannel colorWheelMacros = new FixtureChannel();
			//colorWheelMacros.Name = "Color Wheel Macros";
			//colorWheelMacros.Function = "Color Wheel Macros";
			//colorWheelMacros.ChannelNumber = 5;
			//specification.ChannelDefinitions.Add(colorWheelMacros);
		}
		...
		static private void InitializePrism(FixtureFunction function)
		{
			...
			enum0.StartValue = 0;
			enum0.EndValue = 7;
			enum0.IndexType = FixtureIndexType.PrismClose;
			function.IndexData.Add(enum0);
			...
			enum1.StartValue = 8;
			enum1.EndValue = 255;
			enum1.IndexType = FixtureIndexType.PrismOpen;
			function.IndexData.Add(enum1);
		}
		...
		static private void InitializeRotatingPrism(FixtureFunction function)
		{
			...
			enum0.EndValue = 127;
			enum0.UseCurve = true;
			enum0.IndexType = FixtureIndexType.Prism;
			function.IndexData.Add(enum0);
			...
			enum1.EndValue = 189;
			enum1.UseCurve = true;
			enum1.IndexType = FixtureIndexType.Prism;
			function.IndexData.Add(enum1);
			...
			enum2.EndValue = 193;
			enum2.IndexType = FixtureIndexType.Prism;
			function.IndexData.Add(enum2);
			...
			enum3.EndValue = 255;
			enum3.UseCurve = true;
			enum3.IndexType = FixtureIndexType.Prism;
			function.IndexData.Add(enum3);
		}
		...
		static private void InitializeGobos(FixtureFunction function)
		{
			...
			enum2.StartValue = 8;
			enum2.EndValue = 11;
			enum2.Image = "SmallOpenCircle.png";
			function.IndexData.Add(enum2);
			...
			enum3.StartValue = 12;
			enum3.EndValue = 15;
			enum3.Image = "MediumOpenCircle.png";
			function.IndexData.Add(enum3);
			...
			enum4.StartValue = 16;
			enum4.EndValue = 19;
			enum4.Image = "LargeOpenCircle.png";
			function.IndexData.Add(enum4);
			...
			enum5.StartValue = 20;
			enum5.EndValue = 23;
			enum5.Image = "EightPointNinjaStar.png";
			function.IndexData.Add(enum5);
			...
			enum6.StartValue = 24;
			enum6.EndValue = 27;
			enum6.Image = "FourPointArrowStar.png";
			function.IndexData.Add(enum6);
			...
			enum17.EndValue = 72;
			enum17.Image = "SmallOpenCircle.png";
			...
			enum18.EndValue = 76;
			enum18.Image = "MediumOpenCircle.png";
			...
			enum19.EndValue = 80;
			enum19.Image = "LargeOpenCircle.png";
			...
			enum20.EndValue = 84;
			enum20.Image = "EightPointNinjaStar.png";
			...
			enum21.EndValue = 89;
			enum21.Image = "FourPointArrowStar.png";
		...
		{
			function.FunctionIdentity = FunctionIdentity.SpinColorWheel;
		...
		static private void AddColor(
			...
			bool halfStep,
			bool useCurve,
			bool excludeColorProperty = false)
		{
			...
			c.HalfStep = halfStep;
			c.UseCurve = useCurve;
			c.ExcludeColorProperty = excludeColorProperty;
		...
		//FixtureFunction colorWheelMacros = AddFunctionType(
		//		specification,
		//		"Color Wheel Macros",
		//		FixtureFunctionType.Indexed,
		//		FunctionIdentity.SpinColorWheel);

			//InitializeColorWheelMacros(colorWheelMacros);

			FixtureFunction gobo = specification.FunctionDefinitions.Single(fn => fn.FunctionIdentity == FunctionIdentity.Gobo);
			...
			FixtureFunction prism = specification.FunctionDefinitions.Single(fnc => fnc.Name == "Open Close Prism");
		   ...
		   FixtureFunction rotatingPrism = specification.FunctionDefinitions.Single(fnc => fnc.Name == "Prism");
			//specification,
			//	"Rotating Prism",				
			//	FixtureFunctionType.Indexed,
			//	FunctionIdentity.Custom);
			rotatingPrism.Label = "R";			
			InitializeRotatingPrism(rotatingPrism);

			//FixtureFunction shutterAndStrobing = AddFunctionType(
			FixtureFunction shutterAndStrobing = specification.FunctionDefinitions.Single(fnc => fnc.Name == "Shutter");			
			//specification,
			//	"Shutter & Strobing",
			//	FixtureFunctionType.Indexed,
			//	FunctionIdentity.Shutter);
			shutterAndStrobing.Label = "S";
		...
		static private void InitializeColorWheelMacros(FixtureFunction function)
        {
			AddIndex(function, 			
				"Indexing",
				64,
		...
		static private void InitializeShutter(FixtureFunction function)
		{
			...
			enum2.EndValue = 95;
			enum2.UseCurve = true;
			enum2.IndexType = FixtureIndexType.Strobe;
			function.IndexData.Add(enum2);
			...
			enum4.StartValue = 128;
			enum4.EndValue = 159;
			enum4.IndexType = FixtureIndexType.Strobe;
			function.IndexData.Add(enum4);
			...
			enum6.EndValue = 223;
			enum6.UseCurve = true;
			enum6.IndexType = FixtureIndexType.Strobe;
			function.IndexData.Add(enum6);
